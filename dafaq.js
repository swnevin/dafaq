document.addEventListener('DOMContentLoaded', function () {
    ...
    const VF_KEY = "SET INN API NØKKEL HER - Den som liksom er der ja";
    const VF_PROJECT_ID = "SET INN PROSJEKT ID HER - Inn i settings i vf også bla helt ned";
    const VF_VERSION_ID = "SET INN VERSJONS ID HER - Inn i settings i vf også bla helt ned";
